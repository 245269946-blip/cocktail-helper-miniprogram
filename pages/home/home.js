...
Page({
  data: {
    ...
    featuredRecipes: [
      { id: 'gin-tonic', name: '金汤力', image: illustrations.featurePath('gin-tonic'), demand: '想喝清爽经典', reason: '冰块、青柠和汤力水，第一杯不容易错。', tags: ['清爽', '经典', '新手'] },
      { id: 'whiskey-sour', name: '威士忌酸', image: illustrations.featurePath('whiskey-sour'), demand: '想喝经典酸甜', reason: '厚泡沫、柠檬和威士忌，像在家做一杯正式鸡尾酒。', tags: ['酸甜', '泡沫感', '经典'] },
      { id: 'mojito', name: '莫吉托', image: illustrations.featurePath('mojito'), demand: '想喝薄荷气泡', reason: '青柠、薄荷和气泡水，适合夏天和新手。', tags: ['薄荷', '气泡感', '低门槛'] },
      { id: 'cuba-libre', name: '自由古巴', image: illustrations.featurePath('cuba-libre'), demand: '想喝可乐朗姆', reason: '朗姆、可乐和青柠，经典、直接，也适合朋友局。', tags: ['经典', '可乐', '聚会'] },
      { id: 'white-russian', name: '白俄罗斯', image: illustrations.featurePath('white-russian'), demand: '想喝咖啡奶感', reason: '咖啡棕和奶油白融合，适合夜晚放松。', tags: ['咖啡感', '奶香', '顺滑'] }
    ],
    randomPreview: [],
    firstRecipe: {
      id: 'gin-tonic',
